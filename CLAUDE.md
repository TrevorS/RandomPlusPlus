...
RandomPlusPlus is a RimWorld mod: set a filter for your starting colonists and it rerolls pawns
until one matches. This file covers building, the architecture, and the invariants to respect when
changing things. The user-facing overview is in [README.md](./README.md).
