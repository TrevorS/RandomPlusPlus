...
namespace RandomPlus
{
    public class PanelTraits : PanelBase
    {
        ...
        protected override void DrawPanelContent()
        {
            ...
            if (PawnRandomizer.ModWellMetActive)
            {
            ...
            try
            {
                if (!PawnRandomizer.PawnFilter.Traits.Any())
                {
                ...
                int index = 0;
                foreach (TraitContainer traitContainer in PawnRandomizer.PawnFilter.Traits)
                {
                    ...
                    {
                        field.Label = $"{traitContainer.trait.LabelCap}{LabelForTraitFilter(index)} {PawnRandomizer.GetTraitRollChanceText(traitContainer.trait.def)}";
                    ...
                    field.ClickAction = () =>
                    {
                        ...
                        Dialog_Options<Trait> dialog = new Dialog_Options<Trait>(ProviderTraits.Traits)
                        {
                            ...
                            CloseAction = () =>
                            {
                                PawnRandomizer.PawnFilter.TraitUpdated(localIndex, selectedTrait);
                            },
                            NoneSelectedFunc = () =>
                            {
            ...
            int traitCount = PawnRandomizer.PawnFilter.Traits.Count;
            ...
            if (addButtonEnabled && Widgets.ButtonInvisible(addRect, false))
            {
                ...
                Dialog_Options<Trait> dialog = new Dialog_Options<Trait>(ProviderTraits.Traits)
                {
                    ...
                    NameFunc = (Trait t) =>
                    {
                        return $"{t.LabelCap} {PawnRandomizer.GetTraitRollChanceText(t.def)}";
                    },
                    DescriptionFunc = (Trait t) =>
                    {
                        return t.CurrentData.description;
                    ...
                    CloseAction = () =>
                    {
                        ...
                        {
                            PawnRandomizer.PawnFilter.AddTrait(selectedTrait);
                        }
                    }
                };
                Find.WindowStack.Add(dialog);
            ...
            if (traitsToRemove.Count > 0)
            {
                ...
                {
                    PawnRandomizer.PawnFilter.TraitRemoved(trait);
                }
        ...
        protected void ComputeDisallowedTraits(Trait traitToReplace)
        {
            ...
            foreach (TraitContainer tc in PawnRandomizer.PawnFilter.Traits)
            {
        ...
        //{
        //    Trait currentTrait = PawnRandomizer.PawnFilter.Traits.ElementAt(traitIndex).trait;
        ...
        //    }
        //    while (index != -1 &&
        //           (PawnRandomizer.PawnFilter.Traits.ContainsTrait(ProviderTraits.Traits[index]) ||
        ...
        //    }
        //    PawnRandomizer.PawnFilter.TraitUpdated(traitIndex, newTrait);
        //}
        ...
        {
            PawnRandomizer.PawnFilter.TraitUpdated(traitIndex, null);
        }
        protected void CycleTraitFilter(int index)
        {
            if (index < 0 || index >= PawnRandomizer.PawnFilter.Traits.Count)
                return;

            TraitContainer.TraitFilterType traitFilter = PawnRandomizer.PawnFilter.Traits.ElementAt(index).traitFilter;
            ...
            PawnRandomizer.PawnFilter.Traits.ElementAt(index).traitFilter = traitFilter;
        }
        ...
        protected String LabelForTraitFilter(int index)
        {
            ...
            switch (PawnRandomizer.PawnFilter.Traits.ElementAt(index).traitFilter)
            {
        ...
        public void drawTraitPool()
        {
            ...
            if (Widgets.ButtonText(traitPoolButtonRect, PawnRandomizer.PawnFilter.RequiredTraitsInPool.ToString(), true, true, true))
            {
                ...
                foreach (var rangeOption in new int[] { 0, 1, 2, 3 })
                {
                    ...
                    {
                        PawnRandomizer.PawnFilter.RequiredTraitsInPool = rangeOption;
                    });
